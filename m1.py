...
def get_input_prompt():
    ...
    # Check if the module is None and handle accordingly
    module_name = module.__name__ if module else "<unknown module>" # If the module is None, use a default value
            ...
            with requests.Session() as session:
                ...
                while True:
                    ...
                    if content.get("captcha") and content["captcha"][0] == "Invalid CAPTCHA":
                        ...
                        time.sleep(random.uniform(5, 11.2))
                        continue
